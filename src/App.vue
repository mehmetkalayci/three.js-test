...
onMounted(() => {
  ...
  //   "http://localhost:5173/public/a.glb",
  //   function (gltf) {
  ...
  loader.load(
    ...
    (gltf) => {
      if (gltf && gltf.scene) {
        ...
        scene.children[0].children.forEach(
          (item) => (item.material = boxMaterial)
        );
        ...
        console.log(largeCube.visible=false)
      } else {
